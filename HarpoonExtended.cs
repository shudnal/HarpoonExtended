...
namespace HarpoonExtended
{
    ...
    public partial class HarpoonExtended : BaseUnityPlugin
    {
        ...
        private static ConfigEntry<float> slowFallSpeed;
        private static ConfigEntry<float> slowFallDamageMultiplier;
        ...
        private static ConfigEntry<string> targetWhitelist;
        private static ConfigEntry<string> targetBlacklist;
